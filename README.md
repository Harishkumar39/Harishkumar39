# Hi there, I'm Harish Kumar Ramesh 👋

📍 **Based in:** Trier, Germany  
🎓 **Education:** M.Sc. in Data Science | University of Trier (April 2025 – Present)  
💼 **Professional Background:** Ex-Application Global Support Trainee at RTL CLT-UFA S.A. (Luxembourg)  
...
* **DevOps, Automation & Enterprise Tools:** GitHub Actions, Docker, GitHub Container Registry (GHCR), Pytest, Ruff, Power Automate, Power BI, SAP, Azure, Excel (VBA/Scripting), Selenium
...
* **RTL CLT-UFA S.A. (Luxembourg):** Built automated end-to-end workflows integrating Power Automate with SAP, Excel, and SharePoint; designed Power BI dashboards for advanced data analysis and reporting.
* **Kaar Technology (Chennai, India):** Developed software applications using Angular and Node.js while following industry-standard version control and documentation practices.

---

### 📫 Connect With Me
* **LinkedIn:** [Harish Kumar Ramesh](https://www.linkedin.com/in/r-harishkumar)
* **Languages:** English (C1), German (A1), Tamil (C2)
